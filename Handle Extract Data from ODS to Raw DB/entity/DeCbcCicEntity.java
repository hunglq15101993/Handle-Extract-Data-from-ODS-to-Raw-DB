...
@Entity
@Data
@Table(name = "DE_CBC_CIC")
public class DeCbcCicEntity {

    @Id
    @SequenceGenerator(name = "DE_CBC_SEQ_CIC",
            sequenceName = "SEQ_DE_CBC_CIC", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "DE_CBC_SEQ_CIC")
    @Column(name = "ID")
    private Long id;
